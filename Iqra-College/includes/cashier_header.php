<?php
/**
 * Shared Cashier Header Component
 */
...
<div class="relative">
    <button id="user-menu-button" class="flex items-center space-x-3 bg-white dark:bg-gray-800 p-2 rounded-xl shadow border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all">
        <?php if (!empty($userAvatar) && file_exists(__DIR__ . '/../uploads/avatars/' . $userAvatar)): ?>
            <img src="../uploads/avatars/<?php echo htmlspecialchars($userAvatar); ?>" alt="Profile" class="w-10 h-10 rounded-xl object-cover border-2 border-emerald-500">
        <?php else: ?>
            <div class="bg-gradient-to-br from-emerald-500 to-teal-600 w-10 h-10 rounded-xl flex items-center justify-center">
        ...
        <div class="hidden sm:block text-left">
            ...
            <span class="text-xs text-emerald-600 dark:text-emerald-400">Cashier</span>
        </div>
    ...
    <div id="user-dropdown" class="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 hidden z-50 overflow-hidden">
        <div class="p-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <p class="text-sm text-emerald-600 dark:text-emerald-400">Cashier</p>
        </div>
        <div class="p-2">
